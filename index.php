    ...
    <section class="home-slider owl-carousel">
      <div class="slider-item" style="background-image:url(images/bg_1.jpg);">
        ...
        <div class="container">
          ...
          <div class="col-md-7 ftco-animate">
		    <h1 class="mb-4">ENTREPRENEURS</h1>
          	<span class="subheading">Are you looking for capital to fund your startup?</span>
            <p><a href="#" class="btn btn-primary px-4 py-3 mt-3">more</a></p>
          </div>
        </div>
        </div>
      </div>
      ...
      <div class="slider-item" style="background-image:url(images/bg_2.jpg);">
        ...
        <div class="container">
          <div class="row no-gutters slider-text align-items-center justify-content-start" data-scrollax-parent="true">
          <div class="col-md-7 ftco-animate">
            <h1 class="mb-4">VENTURES</h1>
          	<span class="subheading">Take a minute to learn more about our Projects</span>
            <p><a href="#" class="btn btn-primary px-4 py-3 mt-3">more</a></p>
          </div>
        </div>
        </div>
    ...
    <section class="ftco-section">
    	...
    	<div class="container">
          ...
          <div class="col-lg-9 col-md-8 d-flex align-items-center heading-section heading-section-white ftco-animate">
            <h2 class="mb-3 mb-md-0">INFO BANNER</h2>
          </div>
          <div class="col-lg-3 col-md-4 ftco-animate">
          	<p class="mb-0"><a href="#" class="btn btn-white py-3 px-4">Contact</a></p>
          </div>
        </div>	
    	</div>
    </section>
    ...
    <section class="ftco-section ftco-consult ftco-no-pt ftco-no-pb" style="background-image: url(images/bg_5.jpg);" data-stellar-background-ratio="0.5">
      ...
      <div class="container">
        <div class="row justify-content-center mb-5">
          <div class="col-md-8 text-center heading-section ftco-animate">
            <h2 class="mb-4">Section clients</h2>
            <p>lorem</p>
          </div>
        </div>
